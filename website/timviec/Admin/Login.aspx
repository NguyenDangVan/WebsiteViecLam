<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="timviec.Admin.Login" %>
            ...
            <table style="width: 100%;">
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <asp:LinkButton ID="lbtAdm_DangKyTaiKhoan" runat="server" ForeColor="Black">Đăng ký tài khoản mới</asp:LinkButton>
                    </td>
                </tr>
            </table>
        </div>
