<%@ Page Title="" Language="C#" MasterPageFile="~/default.Master" AutoEventWireup="true" CodeBehind="dangKy.aspx.cs" Inherits="timviec.dangKy" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div id="login">
        <div id="login-timviec">          
            ...
            <div style="text-align:center"><asp:Button ID="btnTimViec" runat="server" Text="Đăng ký Người Tìm Việc" Height="35px" Width="230px" OnClick="btnTimViec_Click" /></div>
        </div>
