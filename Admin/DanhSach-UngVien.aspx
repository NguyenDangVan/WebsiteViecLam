<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.master" AutoEventWireup="true" CodeFile="DanhSach-UngVien.aspx.cs" Inherits="Admin_DanhSach_UngVien" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="width: 100%; height: auto; margin: auto;">
        <center>
            ...
            <asp:GridView ID="grvDS_UngVien" runat="server" Width="1000px" AutoGenerateColumns="False" 
                GridLines="None" AllowPaging="True" OnPageIndexChanging="grvDS_UngVien_PageIndexChanging">
