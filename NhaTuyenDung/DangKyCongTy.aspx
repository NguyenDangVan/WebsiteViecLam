<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DangKyCongTy.aspx.cs" Inherits="NhaTuyenDung_DangKyCongTy" %>
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td colspan="2" style="text-align:center">
                ...
                <asp:Button ID="btnHuy" runat="server" Text="Hủy" Height="30px" Width="80px" />
            </td>
        </tr>
    </table>
</asp:Content>
