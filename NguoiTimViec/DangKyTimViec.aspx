<%@ Page Title="" Language="C#" MasterPageFile="~/default.master" AutoEventWireup="true" CodeFile="DangKyTimViec.aspx.cs" Inherits="NguoiTimViec_DangKyTimViec" %>
    ...
    <table style="width: 100%;">
        ...
        <tr>
            <td colspan="2" style="text-align:center">
                <asp:Button ID="btnDangKyUngVien" runat="server" Text="Đăng ký" Height="30px" Width="80px" OnClick="btnDangKyUngVien_Click"  />&nbsp;&nbsp; <%--OnClick="btnDangKyUngVien_Click"--%>
                <asp:Button ID="btnHuyUngVien" runat="server" Text="Hủy" Height="30px" Width="80px" OnClick="btnHuyUngVien_Click"  /> <%--OnClick="btnHuyUngVien_Click"--%>
            </td>
        </tr>
    </table>
</asp:Content>
